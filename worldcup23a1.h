...
class world_cup_t {
private:
    AVLTree<int, Player*>* m_playersTree;
    AVLTree<Player, Player*>* m_rankedPlayersTree; // Sorted by goals > cards > ids
    AVLTree<int, Team*>* m_teamsTree;
    AVLTree<int, Team*>* m_validTeamsTree;
    int m_teamsNum;
    int m_validTeamsNum;
    int m_totalPlayersNum;

	//
	// Here you may add anything you want
	//
	void forceRemoveTeam(int id, Team* team);
public:
	// <DO-NOT-MODIFY> {
	world_cup_t();
	virtual ~world_cup_t();
